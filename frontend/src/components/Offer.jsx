  ...
  return (
    <section className='max-padd-container bg-banneroffer bg-center bg-cover w-full'>
      <div className='px-4 py-16 md:py-24 lg:py-44'>
        <h2 className='h2'>Trending Gadgets!</h2>
        <h3 className='medium-32 capitalize font-normal'>Great <span className='text-secondary'>Technology </span>gets here first!</h3>
        <Link to={'/products'} className='text-white bg-tertiary pl-6 rounded-full flexBetween gap-x-2 medium-16 w-44 mt-10 group'>
          Go to shop
