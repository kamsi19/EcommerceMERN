    ...
    <footer className='max-padd-container bg-tertiary py-8'>
      <div className='flexCenter flex-col gap-y-4'>
        ...
        <Link to={'/'} className='flex items-center gap-x-2'>
          ...
          <span className='bold-24 hidden xs:flex text-white'>TrustABCElectronics</span>
        </Link>
        {/* Nav */}
        <div className='py-4'>
        ...
        <div className='text-white'>Copyright &copy; TrustABCElectronics | All rights reserved.</div>
      </div>
    </footer>
  )
}
